...
void task3()
{
    ...
    // go to D slash
    if (n_update == 1)
        go_slash_no_line(0.7f, n_initial_yaw, true);
...
#define TASK4_LINE_BASE_SPEED 0.4f // 0.4
#define TASK4_NO_LINE_BASE_SPEED 0.6f // 0.6
...
void task4()
{
    p_initial_yaw = g_jy901_yaw;
    if (n_update == 0)
        n_initial_yaw = p_initial_yaw - 107.0f;
